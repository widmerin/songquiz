...
//		$('#score').find('tbody').append('<tr><td>'+(index+1)+'.</td><td>' + highscore.username + '</td><td>'+ Math.round(highscore.total).toFixed(0) +' %</td></tr>');
		$('#score').find('tbody').append('<tr><td>'+(index+1)+'.</td><td>' + highscore.username + '</td><td>'+ Math.round(highscore.total).toFixed(0) +' %</td><td> of '+ Math.round(highscore.played).toFixed(0) +' songs.</td></tr>');
